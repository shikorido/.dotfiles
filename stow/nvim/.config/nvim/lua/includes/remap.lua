...
vim.keymap.set("n", "<leader>gt", function()
	ToTabs()
	vim.notify("Every " .. vim.bo.tabstop .. " leading space(s) was/were replaced with tabs", vim.log.levels.INFO)
end, { desc = "Replace leading spaces with tabs based on tabstop" })

vim.keymap.set("n", "<leader>gs", function()
	ToSpaces()
	vim.notify("Leading tabs were replaced with " .. vim.bo.tabstop .. " spaces", vim.log.levels.INFO)
end, { desc = "Replace leading tabs with spaces based on tabstop" })
