return {
  {
    ...
    opts = {
      ...
      open_files_do_not_replace_types = { "harpoon", "terminal", "trouble", "qf" }, -- when opening files, do not use windows containing these filetypes or buftypes
      ...
      require("window-picker").setup({
        filter_rules = {
          ...
          bo = {
            ...
            filetype = { "harpoon", "neo-tree", "neo-tree-popup", "notify" },
