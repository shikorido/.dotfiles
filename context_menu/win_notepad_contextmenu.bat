...
REM For adding windows' stock notepad change current dir to System32
cd /d "%SYSTEMROOT%\System32"

@for /f %%f in ('dir /b /a:-d-l') do (
    @if [%%~nxf] == [notepad.exe] (
        echo notepad.exe was found in system directory.
        echo.
...
set REG_KEY=HKLM\SOFTWARE\Classes\^*\shell\005_EditWithNotepad
