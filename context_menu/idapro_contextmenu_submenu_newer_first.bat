...
REM To make IDA versions appear in reverse order (newer first) we can use a simple math
set IDAIDX=1000
set /a IDAIDX-=%IDAVER:~0,1%%IDAVER:~2,1%
...
:again_if_varbit
REM Path to registry key
set REG_KEY=HKLM\SOFTWARE\Classes\^*\shell\%IDX%_OpenWithIDAPro\shell\%IDAIDX%_IDAPro%IDAVER%%REG_BITNESS_SUFFIX%
