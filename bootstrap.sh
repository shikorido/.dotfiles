...
# Since I tend to generalize configs, the branch is no longer required.
#else
#    log ERROR linux/bootstrap.sh "The current $OS_ENV OS env is not supported."
#    rc=1
#fi

if [ "${rc:-0}" -ne 0 ]; then
    log ERROR linux/bootstrap.sh "An error occured"
